...
### Applications
- [ ] Add a project to an application (`api/applications/add_project`)
- [ ] Create a new application (`api/applications/create`)
- [ ] Create a new branch on a given application (`api/applications/create_branch`)
- [ ] Delete an application definition (`api/applications/delete`)
- [ ] Delete a branch on a given application (`api/applications/delete_branch`)
- [ ] Refresh one or all applications (`api/applications/refresh`)
- [ ] Remove a project from an application (`api/applications/remove_project`)
- [ ] List projects manually selected in an application (`api/applications/search_projects`)
- [ ] Set tags on a application (`api/applications/set_tags`)
- [ ] Returns an application and its associated projects (`api/applications/show`)
- [ ] Show leak of an application (`api/applications/show_leak`)
- [ ] Update an application (`api/applications/update`)
- [ ] Update a branch on a given application (`api/applications/update_branch`)
...
### Compute Engine (CE)
- [ ] Search for tasks (`api/ce/activity`)
- [ ] Returns CE activity related metrics (`api/ce/activity_status`)
- [ ] Get the analysis status of a given component (`api/ce/analysis_status`)
- [ ] Cancels a pending task (`api/ce/cancel`)
- [ ] Cancels all pending tasks (`api/ce/cancel_all`)
- [ ] Get the pending tasks, in-progress tasks and the last executed task of a given component (`api/ce/component`)
- [ ] Permanently dismiss a specific analysis warning (`api/ce/dismiss_analysis_warning`)
- [ ] Returns the count of projects with completed issue indexing (`api/ce/indexation_status`)
- [ ] Gets information about Compute Engine (`api/ce/info`)
- [ ] Requests pause of Compute Engine workers (`api/ce/pause`)
- [ ] Resumes pause of Compute Engine workers (`api/ce/resume`)
- [ ] Set the number of workers in the Compute Engine (`api/ce/set_worker_count`)
- [ ] Submits a scanner report to the queue (`api/ce/submit`)
- [ ] Give Compute Engine task details (`api/ce/task`)
- [ ] List available task types (`api/ce/task_types`)
- [ ] Return number of Compute Engine workers (`api/ce/worker_count`)
